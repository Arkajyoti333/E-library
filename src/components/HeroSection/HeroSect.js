...
const Hero = () => {
  ...
  return (
    ...
    <div className="relative w-[90%] mx-auto  rounded-3xl overflow-hidden mt-[75px] pt-3 ">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center text-white">
        ...
        <div className="flex items-center pt-3">
          ...
          />
          <button className="ml-2 bg-green-100 text-black p-2 rounded-md hover:bg-sky-400">
            Search
          </button>
        </div>
      </div>
